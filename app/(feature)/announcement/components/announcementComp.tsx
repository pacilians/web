...
export default function AnnouncementComp({ title, content }: iProps) {
  ...
  return (
    <>
      <div
        className="target flex w-full flex-col rounded bg-white p-2 text-[#575152]"
        onClick={openModal}
      >
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="flex w-3/4 flex-col rounded bg-white p-2 text-[#575152] ">
                  <div className="">
                    <div className="flex flex-row justify-between font-bold">
                      {title}
